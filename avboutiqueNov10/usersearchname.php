...
if(!$lname){
$query1="SELECT * FROM Member WHERE firstname='$fname'";
}
else if(!$fname){
$query1="SELECT * FROM Member WHERE lastname='$lname'";
}
else if(!$fname && !$lname){
die("Empty Fields");
}
else{
$query1="SELECT * FROM Member WHERE firstname='$fname' AND lastname='$lname'";
}
