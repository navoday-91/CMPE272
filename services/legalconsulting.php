...
<!-- start coded_template: id:3859515515 path:generated_layouts/3859515505.html --><!--[if lt IE 7]> <html class="no-js lt-ie9 lt-ie8 lt-ie7" lang="en"> <![endif]--><!--[if IE 7]>    <html class="no-js lt-ie9 lt-ie8" lang="en">        <![endif]--><!--[if IE 8]>    <html class="no-js lt-ie9" lang="en">               <![endif]--><!--[if gt IE 8]><!--><html class="no-js" lang="en"><!--<![endif]--><head>
    ...
    <title>Legal Consulting Services</title>
            ...
            <div class="span12 widget-span widget-type-cell centered column-equal-height medium-stack" style="" data-widget-type="cell" data-x="0" data-w="12">
                ...
                <div class="row-fluid ">
                    <div class="span8 widget-span widget-type-widget_container column main-column" style="" data-widget-type="widget_container" data-x="0" data-w="8">
                        ...
                        When you need expertise in specific practice areas, as well as proven tools, methodology and dedicated full-time consultants – ABC Legal can help.

We provide scoping, advisory, and process improvement consulting for our law firm and corporate client’s legal projects and work flows.

Our dedicated consulting team and technology solutions, can assist you in managing risks, providing controls, and driving efficiencies. Our team has expertise in areas such as:
...
Our proven experience and results-driven approach helps us provide you with effective solutions your team can implement moving forward. Our consulting solutions give you the benefit of world-class consulting and specialized staffing services under one roof.

Contact us today to learn more about our consulting solutions and the benefits of working with ABC Legal Consulting. Read our case studies to see how we've helped other law firms and legal departments.
</div></div></span>
                    </div><!--end widget-span -->
