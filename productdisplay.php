...
fieldset, label { margin: auto; padding: 0;text-align:center }
body{ margin: 20px; }
                    ...
                    <div class="span12 widget-span widget-type-cell centered-small" style="" data-widget-type="cell" data-x="0" data-w="12">
                        ...
                        <div class="row-fluid ">
                            <div class="span12 widget-span widget-type-rich_text " style="" data-widget-type="rich_text" data-x="0" data-w="12">
                                <div class="cell-wrapper layout-widget-wrapper">
                                    <span id="hs_cos_wrapper_module_14509432659418859" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_rich_text" style="" data-hs-cos-general-type="widget" data-hs-cos-type="rich_text"><p>A Description of Product You Selected</p></span>
                                </div><!--end layout-widget-wrapper -->
                            </div><!--end widget-span -->
                        </div><!--end row-->
                        </div><!--end row-wrapper -->
...
<div class="row-fluid ">
  ...
  <div class="dialog-front">
    <div class="dialog-content">
      <form id="reviewform" class="dialog-form" action=<?php echo("php/subreview.php?id=".$id) ?> method="POST">
        <fieldset>
